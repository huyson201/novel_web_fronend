...
const BookDetail = () => {
  ...
  const currentURL = useMemo(() => {
    if (import.meta.env.MODE === "development")
      return "https://tienvuc.xyz/account";
      ...
      <div className={cx("detail-hero")}>
        <div
          ...
          style={{
            ...
            }/api/v1/image?url=${bookState.book?.image})`,
          }}
        ></div>
        <div className={cx("detail-hero__content")}>
          <div className="wrapper">
            ...
            <div className={cx("novel-detail")}>
              ...
              <div className={cx("novel-detail__author")}>
                Tác giả: {bookState.book?.author}
              </div>
              <div className={cx("novel-detail__translator")}>
                <span className={cx("novel-detail__translator-title")}>
                  Dịch giả:
                </span>
                <Link to={"#"}>
                  <IoPersonCircleOutline
                    className={cx("novel-detail__translator-icon")}
                  />
                  <span className={cx("novel-detail__translator-name")}>
                    {bookState.book?.translator}
                  </span>
                </Link>
              </div>
              <div className={cx("novel-detail__views")}>
                <span className={cx("novel-detail__views-title")}>
                  Lượt xem
                </span>
                <span className={cx("novel-detail__views-number")}>
                  {bookState.book?.view}
                </span>
              </div>
              ...
              <div
                className={cx("novel-detail__desc")}
                dangerouslySetInnerHTML={{ __html: bookState.book?.desc || "" }}
              ></div>
      ...
      <div className={cx("chapters-comments")} ref={chaptersCommentRef}>
        <div className="wrapper">
          <div className={cx("list-chapters")}>
            <div className={cx("list-chapters__title")}>DS Chương</div>
